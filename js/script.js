...
// This function tells the user what age catagorie of movies thay can see
'use strict';
function submit() {
	// Declares variable
	let userAge = document.getElementById('age').value
	
	// If statement for user age, what age catagorie of movies thay can see
	if (userAge == "") {
		// Nothing was inputed
		...
		document.getElementById('rating').innerHTML = "You can go see an PG-13 movie with no supervision";
	} else if (userAge >= 10) {
		...
		document.getElementById('rating').innerHTML = "You need supervision to watch any age catagorie of movie";
	} else {
